...
class ApiBarberController extends AbstractController
{
    ...
    public function updatePaiement($id, Request $request, SerializerInterface $serializer, BarberRepository $barberRepository, EntityManagerInterface $em)
    {
    ...
    /**
     * @Route("/api/barber/{id}", name="api_barber_deleteS", methods={"DELETE"})
     */
